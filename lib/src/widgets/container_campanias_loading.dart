...
class ContainerCampaniasLoading extends StatefulWidget {
  

  const ContainerCampaniasLoading({Key key, }) : super(key: key);

  @override
  _ContainerCampaniasLoading createState() => _ContainerCampaniasLoading();
}

class _ContainerCampaniasLoading extends State<ContainerCampaniasLoading> {
